...
### 1. Environment Variables (config.toml)
...
# Model Selection
[models]
default_model = "Qwen/Qwen3-VL-235B-A22B-Instruct-FP8"  # Complex tasks (chat/vision)
# default_model = "Qwen/Qwen3-VL-30B-A3B-Instruct-FP8"   # Simple tasks (faster, cheaper)
